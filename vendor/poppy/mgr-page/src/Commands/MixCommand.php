...
class MixCommand extends Command
{
    ...
    public function handle()
    {
        $files = [
            ...
            'assets/libs/boot/bootstrap.min.js' => 'poppy/mgr-page/resources/libs/boot/bootstrap.min.js',
            ...
            'assets/libs/boot/simditor.min.js'  => 'poppy/mgr-page/resources/libs/simditor/simditor.min.js',
        ];
