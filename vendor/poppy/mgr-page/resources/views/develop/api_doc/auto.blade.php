...
@section('develop-main')
    @include('py-mgr-page::develop.api_doc.nav')
    @if (!$data['file_exists'])
        ...
        <hr>
    @else
        @include('py-mgr-page::develop.api_doc.auto_pam')
        <div class="layui-row layui-col-space10" id="app">
            <div class="layui-col-md6 mt5">
                ...
                --}}
                @include('py-mgr-page::develop.api_doc.auto_token')
                @include('py-mgr-page::develop.api_doc.auto_certificate')
                @include('py-mgr-page::develop.api_doc.auto_params')
		...
		$(function() {
			var conf = Util.validateConfig({
                ...
                @include('py-mgr-page::develop.api_doc.auto_validate')
			}, true);
