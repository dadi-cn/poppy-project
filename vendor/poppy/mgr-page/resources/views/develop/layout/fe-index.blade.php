<div class="layui-row layui-col-space15 mt15">
    <div class="layui-col-xs3" style="line-height: 2;">
        @include('py-mgr-page::develop.layout._side')
    </div>
    ...
    鼠标滑过之后会有提示
        ...
        <div>
            {!! PyForm::checkboxes('is_enable[]', ['N', 'Y']) !!}
        </div>
        ...
        <div>
            {!! PyForm::datePicker('date', null, ['class' => 'layui-input']) !!}
        </div>
        ...
        <div>
            {!! PyForm::dateRangePicker('date', null, ['class' => 'layui-input']) !!}
        </div>
        ...
        <div>
            {!! PyForm::monthPicker('month', null, ['class' => 'layui-input']) !!}
        </div>
