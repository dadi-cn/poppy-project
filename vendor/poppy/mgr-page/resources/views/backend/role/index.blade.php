    ...
    <div class="layui-card-header">
        ...
        <div class="pull-right">
            @can('create', \Poppy\System\Models\PamRole::class)
                <a href="{{route_url('py-mgr-page:backend.role.establish', [], ['type' => $type,])}}"
                    ...
                    <td>
                        @can('permission', $item)
                            <a class="fa fa-user-check J_iframe"
                               ...
                               data-width="600"
                               href="{{route('py-mgr-page:backend.role.menu', [$item->id])}}"></a>
                        @endcan
                        @can('edit', $item)
                            <a class="J_iframe J_tooltip" title="编辑" href="{{route('py-mgr-page:backend.role.establish', [$item->id])}}">
                        ...
                        @can('delete', $item)
                            <a class="text-danger J_request J_tooltip" title="删除角色"
                               ...
                               href="{{route('py-mgr-page:backend.role.delete', [$item->id])}}">
